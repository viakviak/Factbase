...
BEGIN
	...
	if @path IS NULL
		return NULL;
	SET @valueTypeList = '|Boolean|Century|Currency|DayOfWeek|FactSet|File|GeoPoint|Integer|Month|Phrase|Real|Season|Text|Time|TimeAge|TimeDescription|TimePhrase|Uid|Year|';
